...
export default function Intl_Business_Summit() {
    return (
        <section className='intl-business-summit'>
            ...
            <div className='business-summit-card'>
                ...
                <div className='business-summit-card-right'>
                    <img src={Business_submit_img_1} />
                    <img src={Business_submit_img_2} />
                </div>
            </div>
            ...
            <div className='business-summit-card'>
                ...
                <div className='business-summit-card-right'>
                    <img src={Business_submit_img_3} />
                    <img src={Business_submit_img_4} />
                </div>
            </div>
            ...
            <div className='business-summit-card'>
                ...
                <div className='business-summit-card-right'>
                    <img src={Business_submit_img_5} />
                    <img src={Business_submit_img_6} />
                </div>
            </div>
        </section>
    )
